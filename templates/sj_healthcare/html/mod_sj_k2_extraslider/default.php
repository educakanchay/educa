				...
				<?php }?>
					<div class="item-wrap <?php echo $options->theme;?>">
						<div class="item-wrap-inner">
							...
							if($img){
							?>
							<a data-rel="prettyPhoto" href="<?php echo K2ExtrasliderHelper::imageSrc($img); ?>" title="<?php echo $item->title; ?>" class="item-image">
							...
							<!-- Date created -->
							<span class="create"><?php echo $item->author.", "; ?></span>
							<span class="create"><?php echo JHTML::_('date', $item->created , JText::_('DATE_FORMAT_LC1')); ?></span>
