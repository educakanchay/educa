...
<div id="k2Container" class="itemView<?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemCategory">
		<?php
			$string_color=strstr($this->item->category->name, "#" );
			$string_cate=str_replace($string_color, "", $this->item->category->name);
		?>
		<h2>
			<a href="<?php echo $this->item->category->link; ?>"><?php echo $string_cate; ?></a>
		</h2>
		<div class="line"></div>
	</div>
	<?php endif; ?>
			...
			<div class="itemRatingBlock me-inline">
				<div class="itemRatingForm">
					<ul class="itemRatingList">
						<li class="itemCurrentRating" id="itemCurrentRating<?php echo $item->id; ?>" style="width:<?php echo $this->item->votingPercentage; ?>%;"></li>
					...
					<div id="itemRatingLog<?php echo $this->item->id; ?>" class="itemRatingLog"></div>
					<div class="clr"></div>
				</div>
				<div class="clr"></div>
			</div>
